    ...
    <div id = "projects">
        ...
        <div className = {`${layout.section} ${styles.paddingX} mr-0`}>
            <div className = "w-full mx:w-1/3">
                ...
                <div className="sm:mt-[70px] justify-between space-y-4 w-full lg:w-96 h-auto bg-gradient-to-b from-blue-900 to-purple-800 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-400 rounded-xl border-2 z-10 px-[1rem] py-[2rem]">
                    ...
                    <p className = {`${styles.paragraph} sm:text-[16px]`}>
                    Makes use of Bootstrap and W3.CSS to design a responsive layout perfect for all device sizes.
                    </p>
                ...
                <div className="sm:mt-[85px] justify-between space-y-4 w-full lg:w-96 h-auto bg-gradient-to-b from-slate-900 to-slate-800 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-400 rounded-xl border-2 z-10 px-[1rem] py-[2rem]">
                    <div className="flex flex-row justify-center items-center space-x-2">
                        <span className = "font-poppins font-semibold text-[25px] text-white">
            ...
            <div className = "w-full mx:w-1/3">
                <div className="justify-between space-y-4 w-full lg:w-96 h-auto bg-gradient-to-b from-blue-900 to-purple-800 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-400 rounded-xl border-2 z-10 px-[1rem] py-[2rem]">
                    <div className="flex flex-row justify-center items-center space-x-2">
                        <span className = "font-poppins font-semibold text-[25px] text-white">
                            Portfolio Website
                        </span>
                ...
                <div className="sm:mt-[32.5px] justify-between space-y-4 w-full lg:w-96 h-auto bg-gradient-to-b from-slate-900 to-slate-800 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-400 rounded-xl border-2 z-10 px-[1rem] py-[2rem]">
                    <div className="flex flex-row justify-center items-center space-x-2">
                        <span className = "font-poppins font-semibold text-[25px] text-white">
                ...
                <div className="sm:mt-[31.5px] h-auto justify-between space-y-4 w-full lg:w-96 bg-gradient-to-b from-blue-900 to-purple-800 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-400 rounded-xl border-2 z-10 px-[1rem] py-[2rem]">
                    <div className="flex flex-row justify-center items-center space-x-2">
                        <span className = "font-poppins font-semibold text-[25px] text-white">
                            Smart Bin
                        </span>
            ...
            <div className = "w-full mx:w-1/3">
                <div className="justify-between space-y-4 w-full lg:w-96 h-auto bg-gradient-to-b from-slate-900 to-slate-800 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-400 rounded-xl border-2 z-10 px-[1rem] py-[2rem]">
                    <div className="flex flex-row justify-center items-center space-x-2">
                        <span className = "font-poppins font-semibold text-[25px] text-white">
                ...
                <div className="sm:mt-[92px] justify-between space-y-4 w-full lg:w-96 h-auto bg-gradient-to-b from-blue-900 to-purple-800 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-400 rounded-xl border-2 z-10 px-[1rem] py-[2rem]">
                    <div className="flex flex-row justify-center items-center space-x-2">
                        <span className = "font-poppins font-semibold text-[25px] text-white">
                            Mediclada
                        </span>
